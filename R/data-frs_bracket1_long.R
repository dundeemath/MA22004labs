#' UK household income by ethnicity for periods ending 2012 to 2021 (long)
#'
...
#'
#' @name frs_bracket1_long
#' @docType data
#' @format A tbl_df with with 40 rows and 3 variables:
#' \describe{
...
#'   \item{perc}{percent of FRS from a given ethnic group that belong to the first income bracket (up to £200)}
#' }
