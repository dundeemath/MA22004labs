...
5.  Using code from the **infer** package and data from the one sample of size 60 from `ames`, find a confidence interval for the proportion of Ames residents that live in single family home (`Bldg.Type == 1Fam`) with a confidence level of your choosing (other than 95%) and interpret it.
