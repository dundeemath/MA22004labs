...
description: "Lab report consists of answers to exercises 1-6."
output:
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
Here, the first column named `smoke100` contains the categories (levels) 0 and 1. Recall that 1 indicates a respondent has smoked at least 100 cigarettes. The columns named `m` and `f` then refer to gender (m for male or f for female) and the numbers correspond to totals in each category. 
