...
5.  Take 1000 samples each of size 15 from `price/1e3`, and calculate the variance of each sample. Present the distribution of the sample variances in a histogram. Take 1000 samples of size 30 from `price/1e3` and calculate the variance of each sample. Present the distribution of the sample variances in a histogram. Comment on the underlying distribution for the sample variance. What happens to the mean of the sample variance as the sample size increases? *Your solution to this question may be circulated among the class for peer feedback; please make sure it appears on a separate page.* **[6 marks]**
