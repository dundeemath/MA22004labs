---
title: "MA22004/MA52008 Lab 1: Intro to `R` & RStudio"
description: "An interactive lab providing an intro to statistical programming using various data sets including: measurements from physical systems, population time series, and household income data."
output:
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
:::{.noteblock}
The report for Lab 1 consists of answers to exercises 1-4 in the last section of this tutorial. You will upload your submission to [Gradescope](https://www.gradescope.com) as a PDF. A `Quarto` template called *MA22004/MA52008 Lab Report* is provided. Further details about how to use the template to create your report are included in Section "RStudio and lab reports" of this interactive Lab. 
:::
...
```{r r-interface-2020, fig.margin = TRUE, echo = FALSE, fig.width = 3, out.width = "100%", fig.cap="A fresh *RStudio* window. Please try to use `R` version **4.1.0**."}
...
As part of your grade for MA22004/MA52008, you will need to submit lab reports. I have provided a template file that can be accessed through RStudio after you install and load the `MA22004labs` package (recall that the package can be loaded by typing `library(MA22004labs)` at the RStudio console prompt). 
