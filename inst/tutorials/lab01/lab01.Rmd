...
knitr::opts_knit$set(root.dir = "inst/tutorials/lab01")
```
...
:::{.noteblock}
The report for Lab 1 consists of answers to exercises 1-4 in the last section of this tutorial. You will upload your submission to [Gradescope](https://www.gradescope.com) as a PDF. A `Quarto` template called *MA22004 Lab Report* is provided. Further details about how to use the template to create your report are included in Section "RStudio and lab reports" of this interactive Lab. 
:::
...
```{r r-interface-2020, fig.margin = TRUE, echo = FALSE, fig.width = 3, out.width = "100%", fig.cap="A fresh *RStudio* window. Please try to use `R` version **4.1.0"** or higher."}
