...
We load packages with the `library` function. Copy and paste or type the the following code into your console to load the `tidyverse` package into your working environment. 
